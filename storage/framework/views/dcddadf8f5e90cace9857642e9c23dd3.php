...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo $__env->yieldContent('title', 'Maintence'); ?></title>
    ...
    <body class=" bg-slate-50">
        <section class="bg-white dark:bg-gray-900 flex min-h-screen justify-center items-center">
...
<?php /**PATH /home/hamsterkaget/Development/Web-App/gib-shop/resources/views/maintenence/index.blade.php ENDPATH**/ ?>