    ...
    <body class="bg-gray-100 font-sans leading-normal tracking-normal">
        <div x-data="setup()" x-init="$refs.loading.classList.add('hidden');" :class="{ 'dark': isDark}">
            ...
            <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
                ...
                <!-- Sidebar -->
                <aside class="flex-shrink-0 hidden md:block w-64 bg-white border-r dark:border-blue-800 dark:bg-darker">
                    ...
                    <div class="flex flex-col h-full">
                        ...
                        <!-- Dashboards links -->
                            ...
                            <div class="flex flex-col items-center pb-10">
                                <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="/images/images/user.png" alt="User Picture"/>
                                <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white"><?php echo e(Auth::user()->name); ?></h5>
                                <span class="text-sm text-gray-500 dark:text-gray-400"><?php echo e(Auth::user()->email); ?></span>
                            </div>
                        ...
                        <div x-data="{ isActive: true, open: true}">
                            ...
                            <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                                <a
                                    href="<?php echo e(route('user-dashboard.home')); ?>"
                                    role="menuitem"
                                ...
                                <a
                                    href="<?php echo e(route('user-dashboard.transaction')); ?>"
                                    role="menuitem"
                                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                                >
                                    Transaction
                                ...
                                <a
                                    href="<?php echo e(route('user-dashboard.ticket')); ?>"
                                    role="menuitem"
                                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                                >
                                    Ticket
...
<?php /**PATH C:\Users\radja\OneDrive\Documents\Development\works\gib-shop\resources\views/user/layouts/dashboard.blade.php ENDPATH**/ ?>