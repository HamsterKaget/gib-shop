...
<script>
    ...
    function getData(params, pageUrl = "<?php echo e(route('user-dashboard.v2.certificates.getData')); ?>") {
        axios.get(pageUrl, {
            params: params
        })
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hamsterkaget/Development/Web-App/gib-shop/resources/views/backend/sections/user/certificate/index.blade.php ENDPATH**/ ?>