                ...
                <aside class="flex-shrink-0 hidden md:block w-64 bg-white border-r dark:border-blue-800 dark:bg-darker">
                    ...
                    <div class="flex flex-col h-full">
                        ...
                        <div x-data="{ isActive: false, open: false }">
                            ...
                            <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                                <a
                                    href="<?php echo e(route('dashboard.manage-event.index')); ?>"
                                    role="menuitem"
                                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700 <?php echo e(Route::currentRouteName() === 'dashboard.manage-event.index' ? 'text-gray-700 dark:text-light' : ''); ?>"
                                >
                                    Manage Event
                                </a>
                                <a
                        ...
                        <div x-data="{ isActive: false, open: false}">
                            ...
                            <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                                <a
                                    href="<?php echo e(route('dashboard.manage-user.index')); ?>"
                                    role="menuitem"
                                    class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"
                                >
                                    Manage User
...
<?php /**PATH C:\Users\radja\OneDrive\Documents\Development\works\gib-shop\resources\views/admin/layouts/base.blade.php ENDPATH**/ ?>