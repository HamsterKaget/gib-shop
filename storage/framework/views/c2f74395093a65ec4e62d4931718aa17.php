            ...
            <div class="swiper-container" style="height: 400px; margin: 5% 0px;">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img class="mx-auto rounded-lg" src="<?php echo e(asset('images/hero-slide-3.webp')); ?>" alt="Slide 1">
                    </div>
                    <div class="swiper-slide">
                        <img class="mx-auto rounded-lg" src="<?php echo e(asset('images/hero-slide-3.webp')); ?>" alt="Slide 1">
                    </div>
        ...
        <section class="bootcamp my-12">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <a href="bootcamp/detail/1" class="block bg-white rounded-xl overflow-hidden shadow-lg">
                    <img class="h-54 w-full object-cover" src="<?php echo e(asset('images/public.avif')); ?>" alt="Card Image">
                    <div class="p-4">
...
<?php echo $__env->make('user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\radja\OneDrive\Documents\Development\works\gib-shop\resources\views/user/modules/mini-event/index.blade.php ENDPATH**/ ?>