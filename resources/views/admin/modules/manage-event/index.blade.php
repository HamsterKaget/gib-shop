...
@section('content')
    <div class="w-full min-h-screen shadow-lg rounded-lg p-4">
        ...
        <div class="bg-white shadow-lg rounded-lg mt-4 p-4">
            ...
            <table class="overflow-x-auto w-full max-w-7xl">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    @foreach ($programs as $program)
                        <tr class="text-center">
                            ...
                            <td class="border px-4 py-2 text-sm">{{ $program->title }}</td>
                            <td class="border px-4 py-2">
                                <img src="{{ asset($program->thumbnail) }}" alt="thumbnail" class="max-h-32">
                            </td>
                            <td class="border px-4 py-2">
                                <button class="bg-indigo-500 hover:bg-indigo-700 text-white py-1.5 px-3 rounded flex items-center justify-center shadow-lg">
                            ...
                            <td class="border px-4 py-2">
                                {{-- wrap the $program into json in this button --}}
                                <div class="flex">
                                    ...
                                    <button class="bg-red-500 hover:bg-red-700 text-white py-1 px-3 rounded ml-2" onclick="deleteUser({{ $program->id }})">
                    ...
                    <form id="user-form" method="post" onsubmit="event.preventDefault(); createOrUpdate();">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-3">
                            ...
                            <div>
                                ...
                                <input type="number" min="0" id="stock" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                            </div>
                            <div>
...
<script>
    ...
    const defaultModal = new Modal($defaultModal, options);
