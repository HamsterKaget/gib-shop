...
<div class="p-4 pb-12 pt-20 sm:ml-72">
    {{-- <div class="my-4 text-center">
        <h2 class="text-xl font-extrabold leading-none tracking-tight text-gray-900 md:text-3xl lg:text-4xl dark:text-white">Transactions <span class="bg-blue-100 text-blue-800 text-2xl font-semibold mr-2 px-2.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-2">Beta</span></h2>
            ...
            <div class="border border-gray-400 rounded-lg">
                <form id="updateProfileForm" action="" method="POST" class="w-full">
                    <div class="grid grid-cols-1  gap-2.5 w-full mx-auto rounded-xl px-8 pt-4 pb-4">
                        <div>
                            <img class="rounded-full w-24 h-24 mx-auto border-gray-300 shadow-lg border" src="{{ asset('images/person.png') }}" alt="image description">
                        </div>
                        <div>
