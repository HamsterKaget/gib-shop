      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="{{ route('home') }}" class="flex ml-2 md:mr-24">
            ...
            <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">GatheringInBali</span>
          </a>
        </div>
        <div class="flex items-center">
            ...
            <div class="flex items-center md:order-2 order-2">
                ...
                <img class="w-8 h-8 rounded-full border border-black" src="{{ asset('images/person.png') }}" alt="user photo">
                ...
                <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
                    ...
                    <ul class="py-2 text-center" aria-labelledby="user-menu-button">
                        <li>
                            <a href="{{ route('user-dashboard.v2.home') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Dashboard</a>
                        </li>
                        <li>
                            <a href="{{ route('user-dashboard.v2.transactions.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">History Transactions</a>
                        </li>
                        <li>
...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-72 h-screen bg-indigo-600 pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    ...
    @else
        <ul class="space-y-2 font-medium">
            <li>
                <a href="{{ route('user-dashboard.v2.home') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ url()->current() == route('user-dashboard.v2.home') ? 'text-indigo-600 font-semibold p-1.5 ml-2 bg-gray-200  dark:bg-gray-700' : '' }}">
                    <svg class="{{  url()->current() == route('user-dashboard.v2.home') ? 'text-indigo-600 w-6 h-6' : 'text-gray-500 w-5 h-5 group-hover:text-gray-900'  }} transition duration-75 dark:text-gray-400  dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                    <path d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z"/>
                    <path d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51 8.51 0 0 0 12.5 0Z"/>
                    </svg>
            ...
            <li>
                <a href="{{ route('user-dashboard.v2.ticket.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ url()->current() == route('user-dashboard.v2.ticket.index') ? 'text-indigo-600 font-semibold p-1.5 ml-2 bg-gray-200  dark:bg-gray-700' : '' }}">
                    <svg class="{{  url()->current() == route('user-dashboard.v2.ticket.index') ? 'text-indigo-600 w-6 h-6' : 'text-gray-500 w-5 h-5 group-hover:text-gray-900'  }} transition duration-75 dark:text-gray-400  dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 14">
            ...
            <li>
                <a href="{{ route('user-dashboard.v2.transactions.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ url()->current() == route('user-dashboard.v2.transactions.index') ? 'text-indigo-600 font-semibold p-1.5 ml-2 bg-gray-200  dark:bg-gray-700' : '' }}">
                    <svg class="{{  url()->current() == route('user-dashboard.v2.transactions.index') ? 'text-indigo-600 w-6 h-6' : 'text-gray-500 w-5 h-5 group-hover:text-gray-900'  }} transition duration-75 dark:text-gray-400  dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M11.074 4 8.442.408A.95.95 0 0 0 7.014.254L2.926 4h8.148ZM9 13v-1a4 4 0 0 1 4-4h6V6a1 1 0 0 0-1-1H1a1 1 0 0 0-1 1v13a1 1 0 0 0 1 1h17a1 1 0 0 0 1-1v-2h-6a4 4 0 0 1-4-4Z"/>
                        <path d="M19 10h-6a2 2 0 0 0-2 2v1a2 2 0 0 0 2 2h6a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1Zm-4.5 3.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2ZM12.62 4h2.78L12.539.41a1.086 1.086 0 1 0-1.7 1.352L12.62 4Z"/>
                    </svg>
            ...
            <li>
                <a href="{{ route('user-dashboard.v2.certificates.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ url()->current() == route('user-dashboard.v2.certificates.index') ? 'text-indigo-600 font-semibold p-1.5 ml-2 bg-gray-200  dark:bg-gray-700' : '' }}">
                    <svg class="{{  url()->current() == route('user-dashboard.v2.certificates.index') ? 'text-indigo-600 w-6 h-6' : 'text-gray-500 w-5 h-5 group-hover:text-gray-900'  }} transition duration-75 dark:text-gray-400  dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 21 21">
            ...
            <li>
                <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                    ...
                    <li>
                        <a href="{{ route('user-dashboard.v2.edit-profile.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ url()->current() == route('user-dashboard.v2.edit-profile.index') ? 'text-indigo-600 font-semibold p-1.5 ml-2 bg-gray-200  dark:bg-gray-700' : '' }}">
                            <svg class="{{  url()->current() == route('user-dashboard.v2.edit-profile.index') ? 'text-indigo-600 w-5 h-5' : 'text-gray-500 w-5 h-5 group-hover:text-gray-900'  }} transition duration-75 dark:text-gray-400  dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 14 18">
                                <path d="M7 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9Zm2 1H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5Z"/>
                            </svg>
